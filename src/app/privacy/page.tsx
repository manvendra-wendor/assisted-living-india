...
export default function PrivacyPage() { return <ContentPage eyebrow="Your information" title="Privacy policy" intro="This policy explains what the directory collects and how family and operator enquiries are used." updated="10 September 2026" sections={[
  { title: "Information we collect", paragraphs: ["We collect information you submit through enquiry, concierge and listing forms. This may include contact details, relationship to the person seeking care, preferred location, broad care needs and property information. Do not submit detailed medical records."] },
  { title: "How information is used", paragraphs: ["We use information to respond to requests, provide agreed introductions, review listing submissions, improve the directory and comply with legal obligations. We do not sell personal data."], bullets: ["Deliver the service you request", "Send relevant operational communications", "Prevent spam and misuse", "Measure aggregate product performance"] },
