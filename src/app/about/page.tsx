...
]} /><section className="section section-dark"><div className="narrow" style={{ textAlign: "center" }}><h2>Start with a clearer shortlist.</h2><p style={{ color: "#b8c7c0" }}>Compare profiles independently or ask our concierge to help organise the questions.</p><Link className="button button-gold" href="/browse">Explore residences <ArrowRight size={16} /></Link></div></section></>; }
