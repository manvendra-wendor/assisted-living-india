...
export const metadata: Metadata = { title: "About Us", description: "Why Assisted Living India is building a clearer, more transparent way to compare premium eldercare." };

export default function AboutPage() { return <><ContentPage eyebrow="Our purpose" title="Better information for one of life’s biggest decisions" intro="Assisted Living India is being built to make premium eldercare easier to understand, compare and discuss as a family." sections={[
